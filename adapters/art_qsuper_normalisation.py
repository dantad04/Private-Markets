...
from adapters.art_qsuper_errors import InvalidDateError, InvalidNumericError, OutOfRangePercentError
...
def parse_textual_date(value: str, row_number: int) -> datetime.date:
    stripped = clean_cell(value)
    if stripped.casefold() in NULL_TOKENS:
