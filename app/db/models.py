...
class Entity(Base):
    ...
    abn_review_source: Mapped[str | None] = mapped_column(String(255), nullable=True)
    abn_reviewed_by: Mapped[str | None] = mapped_column(String(255), nullable=True)
    abn_reviewed_at: Mapped[date | None] = mapped_column(Date, nullable=True)
    registered_name_on_abr: Mapped[str | None] = mapped_column(String(255), nullable=True)
    acn: Mapped[str | None] = mapped_column(String(32), nullable=True)
    asic_company_status: Mapped[str | None] = mapped_column(String(128), nullable=True)
    asic_company_type: Mapped[str | None] = mapped_column(String(255), nullable=True)
    asic_registration_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    asic_next_review_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    asic_record_url: Mapped[str | None] = mapped_column(Text, nullable=True)
    asic_review_source: Mapped[str | None] = mapped_column(String(255), nullable=True)
    asic_reviewed_by: Mapped[str | None] = mapped_column(String(255), nullable=True)
    asic_reviewed_at: Mapped[date | None] = mapped_column(Date, nullable=True)
