...
AWARE_INVESTMENT_FUNDS_2025_APPROVED_MAPPING = ApprovedAdapterMappingSeed(
    id=AWARE_INVESTMENT_FUNDS_2025_MAPPING_VERSION_ID,
    adapter_key="AwarePhdAdapter",
    schema_fingerprint="5f32c5b412bf04749982c45080dfec21e9e2e46911971d1a9d6e1f2277cb1e0a",
    structural_expectations_json={
        "observed_headers": EXPECTED_TABLE_1_HEADER,
        "observed_section_labels": [
            "ASSETS",
    ...
    notes="Approved Stage 2 Aware 2025-12-31 Investment Funds mapping.",
    approved_by="repo-seed",
    ...
    taxonomy_rows=(
        ...
        ApprovedTaxonomyMappingSeed(
            "LISTED PROPERTY", None, None, "ASSETS", "listed_property", False, None, "Table 1 direct holding"
        ),
        ApprovedTaxonomyMappingSeed(
            "UNLISTED ALTERNATIVES",
            "EXTERNALLY",
...
APPROVED_MAPPING_SEEDS: dict[str, tuple[ApprovedAdapterMappingSeed, ...]] = {
    AWARE_APPROVED_MAPPING.adapter_key: (
        AWARE_APPROVED_MAPPING,
        AWARE_INVESTMENT_FUNDS_2025_APPROVED_MAPPING,
    ),
