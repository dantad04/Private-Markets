...
class TestMarronGroupHoldingsEntityDetailApi(unittest.TestCase):
    ...
    def test_marron_company_page_renders_dependency_only_company_detail_without_warrant_or_asic_drift(self) -> None:
        ...
        self.assertIn("Marron Group Holdings Pty Ltd", response.text)
