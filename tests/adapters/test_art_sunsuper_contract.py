...
CONTRACT_PATH = Path("tests/adapters/contracts/art_sunsuper/canonical_output.json")
...
class TestArtSunsuperFrozenContract(unittest.TestCase):
    maxDiff = None

    def test_art_sunsuper_fixture_matches_frozen_contract(self) -> None:
...
def _build_contract_mismatch_message(expected: dict[str, object], actual: dict[str, object]) -> str:
    ...
    return "Frozen ART-Sunsuper contract drift detected.\n\n" + "\n\n".join(mismatches)
