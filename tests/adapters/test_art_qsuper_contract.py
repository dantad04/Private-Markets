...
CONTRACT_PATH = Path("tests/adapters/contracts/art_qsuper/canonical_output.json")
...
class TestArtQsuperFrozenContract(unittest.TestCase):
    maxDiff = None

    def test_art_qsuper_fixture_matches_frozen_contract(self) -> None:
...
def _build_contract_mismatch_message(expected: dict[str, object], actual: dict[str, object]) -> str:
    ...
    return "Frozen ART-QSuper contract drift detected.\n\n" + "\n\n".join(mismatches)
