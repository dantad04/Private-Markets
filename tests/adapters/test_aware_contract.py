...
CONTRACT_PATH = Path("tests/adapters/contracts/aware/canonical_output.json")
...
class TestAwareFrozenContract(unittest.TestCase):
    ...
    def test_aware_fixture_matches_frozen_contract(self) -> None:
...
def _build_contract_mismatch_message(expected: dict[str, object], actual: dict[str, object]) -> str:
    ...
    return "Frozen Aware contract drift detected.\n\n" + "\n\n".join(mismatches)
