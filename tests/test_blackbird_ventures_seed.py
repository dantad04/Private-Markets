...
from app.entity_resolution.private_entity_asic_company_register_cross_reference import (
    ...
    ASIC_REVIEWED_BY,
    ASIC_REVIEW_SOURCE,
    BLACKBIRD_VENTURES_ACN,
    BLACKBIRD_VENTURES_ASIC_CROSS_REFERENCE,
    BLACKBIRD_VENTURES_ASIC_NEXT_REVIEW_DATE,
    BLACKBIRD_VENTURES_ASIC_REGISTRATION_DATE,
    ensure_blackbird_ventures_asic_company_register_cross_reference,
)
...
class TestBlackbirdVenturesSeed(unittest.TestCase):
    ...
    def test_canonical_manager_seed_persists_reviewed_identity_in_place_and_is_idempotent(self) -> None:
        with self.SessionLocal() as session:
            ...
            self.assertEqual(BLACKBIRD_VENTURES_ACN, entity.acn)
            ...
            self.assertEqual(BLACKBIRD_VENTURES_ASIC_REGISTRATION_DATE, entity.asic_registration_date)
            self.assertEqual(BLACKBIRD_VENTURES_ASIC_NEXT_REVIEW_DATE, entity.asic_next_review_date)
            self.assertEqual(BLACKBIRD_VENTURES_ASIC_CROSS_REFERENCE.record_url, entity.asic_record_url)
    ...
    def test_manager_detail_renders_reviewed_identity_layer_and_keeps_fund_vehicle_rows_outside_boundary(
        ...
        with self.SessionLocal() as session:
            ...
            self.assertEqual(BLACKBIRD_VENTURES_ACN, detail.acn)
            ...
            self.assertEqual(BLACKBIRD_VENTURES_ASIC_REGISTRATION_DATE, detail.asic_registration_date)
            self.assertEqual(BLACKBIRD_VENTURES_ASIC_NEXT_REVIEW_DATE, detail.asic_next_review_date)
            self.assertEqual(BLACKBIRD_VENTURES_ASIC_CROSS_REFERENCE.record_url, detail.asic_record_url)
