"""seed Catalyst Investment Managers canonical manager entity"""
...
CATALYST_INVESTMENT_MANAGERS_ALIASES: tuple[tuple[str, str, bool], ...] = (
    (
...
def upgrade() -> None:
    ...
    bind.execute(
        ...
        {
            "entity_type": "manager",
            "canonical_name_insert": CATALYST_INVESTMENT_MANAGERS_CANONICAL_NAME,
            "canonical_name_lookup": CATALYST_INVESTMENT_MANAGERS_CANONICAL_NAME,
    ...
    for alias, alias_normalized, is_preferred in CATALYST_INVESTMENT_MANAGERS_ALIASES:
        bind.execute(
            sa.text(
                """
