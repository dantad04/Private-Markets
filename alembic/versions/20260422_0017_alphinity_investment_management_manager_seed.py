"""seed Alphinity Investment Management canonical manager entity"""
...
ALPHINITY_INVESTMENT_MANAGEMENT_ALIASES: tuple[tuple[str, str, bool], ...] = (
    (
...
def upgrade() -> None:
    ...
    bind.execute(
        ...
        {
            "entity_type": "manager",
            "canonical_name_insert": ALPHINITY_INVESTMENT_MANAGEMENT_CANONICAL_NAME,
            "canonical_name_lookup": ALPHINITY_INVESTMENT_MANAGEMENT_CANONICAL_NAME,
    ...
    for alias, alias_normalized, is_preferred in ALPHINITY_INVESTMENT_MANAGEMENT_ALIASES:
        bind.execute(
            sa.text(
                """
