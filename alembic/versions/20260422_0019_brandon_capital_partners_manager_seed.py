"""seed Brandon Capital Partners canonical manager entity"""
...
BRANDON_CAPITAL_PARTNERS_ALIASES: tuple[tuple[str, str, bool], ...] = (
    (
...
def upgrade() -> None:
    ...
    bind.execute(
        ...
        {
            "entity_type": "manager",
            "canonical_name_insert": BRANDON_CAPITAL_PARTNERS_CANONICAL_NAME,
            "canonical_name_lookup": BRANDON_CAPITAL_PARTNERS_CANONICAL_NAME,
    ...
    for alias, alias_normalized, is_preferred in BRANDON_CAPITAL_PARTNERS_ALIASES:
        bind.execute(
            sa.text(
                """
