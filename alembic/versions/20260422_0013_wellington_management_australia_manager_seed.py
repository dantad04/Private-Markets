"""seed Wellington Management Australia canonical manager entity"""
...
WELLINGTON_MANAGEMENT_AUSTRALIA_ALIASES: tuple[tuple[str, str, bool], ...] = (
    (
...
def upgrade() -> None:
    ...
    bind.execute(
        ...
        {
            "entity_type": "manager",
            "canonical_name_insert": WELLINGTON_MANAGEMENT_AUSTRALIA_CANONICAL_NAME,
            "canonical_name_lookup": WELLINGTON_MANAGEMENT_AUSTRALIA_CANONICAL_NAME,
    ...
    for alias, alias_normalized, is_preferred in WELLINGTON_MANAGEMENT_AUSTRALIA_ALIASES:
        bind.execute(
            sa.text(
                """
            ...
            ),
            {
                ...
                "source_system": "wellington-management-australia-stage5-v1",
