"""seed Bentham Asset Management canonical manager entity"""
...
BENTHAM_ASSET_MANAGEMENT_ALIASES: tuple[tuple[str, str, bool], ...] = (
    ("Bentham Asset Management Pty Ltd", "bentham asset management pty ltd", True),
)
...
def upgrade() -> None:
    ...
    bind.execute(
        ...
        {
            "entity_type": "manager",
            "canonical_name_insert": BENTHAM_ASSET_MANAGEMENT_CANONICAL_NAME,
            "canonical_name_lookup": BENTHAM_ASSET_MANAGEMENT_CANONICAL_NAME,
    ...
    for alias, alias_normalized, is_preferred in BENTHAM_ASSET_MANAGEMENT_ALIASES:
        bind.execute(
            sa.text(
                """
