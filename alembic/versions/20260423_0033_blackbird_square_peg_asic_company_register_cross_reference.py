"""backfill ASIC company-register cross-reference for Blackbird and Square Peg"""
...
from app.entity_resolution.private_entity_asic_company_register_cross_reference import (
    ...
    ensure_blackbird_square_peg_asic_company_register_cross_reference_subset,
)
...
def upgrade() -> None:
    ...
    try:
        ensure_blackbird_square_peg_asic_company_register_cross_reference_subset(session)
        session.commit()
    finally:
        session.close()
