...
FIXTURE_PATH = Path("tests/fixtures/hesta_synthetic_high_growth_contract.csv")
OUTPUT_PATH = Path("tests/adapters/contracts/hesta/canonical_output.json")
WARNING_TEXT = "THIS REWRITES THE STAGE 1 CONTRACT. COMMIT THE CHANGE WITH AN EXPLICIT MESSAGE EXPLAINING WHY."
