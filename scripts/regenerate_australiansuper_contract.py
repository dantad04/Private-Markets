...
OUTPUT_PATH = Path("tests/adapters/contracts/australiansuper/member_direct_canonical_output.json")
WARNING_TEXT = (
    "THIS REWRITES THE STAGE 2 AUSTRALIANSUPER CONTRACT. COMMIT THE CHANGE WITH AN EXPLICIT "
    "MESSAGE EXPLAINING WHY."
)


def build_parser() -> ArgumentParser:
    parser = ArgumentParser(description="Regenerate the frozen AustralianSuper adapter contract artifact.")
    parser.add_argument("--confirm", action="store_true", help="Actually rewrite member_direct_canonical_output.json.")
    return parser
